...
public class MultipleChoices : MonoBehaviour
{
    ...
    public GameObject quizPopup; // Reference to the popup panel object
    public Button resetButton; // Reference to the reset button in the popup
    ...
    void SetQuestion(int questionIndex)
    {
        ...
        // Shuffle the answer buttons' texts array
